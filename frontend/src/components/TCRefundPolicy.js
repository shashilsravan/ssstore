...
export default function TCRefundPolicy() {
    return (
        <div className="my-5">
            <Helmet>
                <title>Chaotic | Terms and Conditions</title>
            </Helmet>
            ...
            <p>
                This website is operated by Chaotic. 
                Throughout the site, the terms “we”, “us” and “our” refer to Chaotic. 
                Chaotic offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
            </p>
            <br />
...
We do not warrant that the quality of any products, services, information, or other material purchased or obtained by you will meet your expectations, or that any errors in the Service will be corrected.</p>
            ...
            <h5>6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h5>
            ...
            <br />
            <h5>9 - CHANGES TO TERMS OF SERVICE</h5>
...
We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.</p>
            ...
            <p>
                If by any problem, you want to cancel your order, contact us at <a href="mailto:support@chaoticstores.com">support@chaoticstores.com</a>.
                 We will get back to you for the order cancellation and if the order amount is paid we will assure you a refund.
            </p>
